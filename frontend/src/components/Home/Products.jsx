    ...
    <section className="py-8">
      <div className="container">
        ...
        <div className="grid justify-center gap-8 md:grid-cols-2 lg:grid-cols-3">
          {/* single product */}
          <div class="w-full max-w-sm bg-white   rounded-md shadow-cardShadow">
            <a href="/products/id" className="flex items-center justify-center">
              <img
            ...
            <div class="px-5 pb-5">
              <a href="/products/id">
                <h5 class="text-base font-medium tracking-tight hover:text-primary transition">
              ...
              <div class="flex items-center justify-between">
                <span class="text-base font-medium">BDT 599</span>
                <button class="bg-primary text-white  hover:bg-primaryHover transition-all   font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                  Add to cart
                </button>
              </div>
            </div>
