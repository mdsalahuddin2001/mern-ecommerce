...
const EditProduct = () => {
  ...
  const [
    updateProduct,
    { isLoading, isSuccess, isError: isEditError, error: editError },
  ] = useUpdateProductMutation();
  ...
  const handleSubmit = (values) => {
    console.log(values);
    updateProduct({ id: params.id, data: values });
  };
  ...
  } else if (isGetProductError) {
    content = (
      <div>
        <Alert type="danger">{getProductError?.data?.message}</Alert>
      </div>
    );
  } else if (product) {
    content = (
            ...
            <Form className="space-y-8 divide-y divide-gray-200 max-w-7xl">
              <div className="space-y-8 divide-y divide-gray-200">
                <div className="pt-8">
                  ...
                  {isEditError && editError && (
                    <Alert type="danger">{editError?.data?.message}</Alert>
                  )}
                </div>
              </div>
              ...
              <div className="pt-5">
                <div className="flex justify-end">
                  ...
                  >
                    {isLoading && <ButtonLoader />} Edit Product
                  </button>
                </div>
              </div>
            </Form>
